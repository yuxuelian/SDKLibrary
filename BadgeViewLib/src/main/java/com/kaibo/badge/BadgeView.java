...
public class BadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = DisplayUtil.dp2px(getContext(), 12);
        mBadgePadding = DisplayUtil.dp2px(getContext(), 4);
        mBadgeNumber = 0;
    ...
    protected void screenFromWindow(boolean screen) {
        ...
        if (screen) {
            mActivityRoot.addView(this, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT));
        } else {
