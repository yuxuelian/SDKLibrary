...
public class SwipeBackLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthSize = SystemUiUtils.getRealScreenWidth(mActivity);
        int heightSize = SystemUiUtils.getRealScreenHeight(mActivity);
        ...
        if (!mIsNavigationBarOverlap && SystemUiUtils.isPortrait(mActivity)) {
            maxLayoutHeight -= SystemUiUtils.getNavigationBarHeight(mActivity);
        }

        if (mIsNavigationBarOverlap && !SystemUiUtils.isPortrait(mActivity)) {
            widthSize += SystemUiUtils.getNavigationBarHeight(mActivity);
        }
        float weightSum = 0;
    ...
    void onPanelDragged(int newLeft) {
        ...
        mShadowView.setTranslationX(-mShadowView.getMeasuredWidth() + newLeft);
    ...
    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        ...
        public void invalidateChildRegion(SwipeBackLayout parent, View child) {
            parent.postInvalidateOnAnimation(child.getLeft(), child.getTop(), child.getRight(), child.getBottom());
        }
    }
    ...
    static class SlidingPanelLayoutImplJBMR1 extends SlidingPanelLayoutImplBase {
        @Override
        public void invalidateChildRegion(SwipeBackLayout parent, View child) {
            child.setLayerPaint(((LayoutParams) child.getLayoutParams()).dimPaint);
        }
    }
    ...
    class AccessibilityDelegate extends View.AccessibilityDelegate {
         ...
         */
        private void copyNodeInfoNoChildren(AccessibilityNodeInfo dest,
                                            AccessibilityNodeInfo src) {
