...
public class RefreshLayoutFooter extends NestedLinearLayout implements PullRefreshLayout.OnPullListener {
    ...
    protected void initView(Context context) {
        ...
        FrameLayout.LayoutParams lpArrow = new FrameLayout.LayoutParams(dipToPx(getContext(), 20), dipToPx(getContext(), 20));
        mImageContainer.addView(mArrowView, lpArrow);
        FrameLayout.LayoutParams lpProgress = new FrameLayout.LayoutParams(dipToPx(getContext(), 20), dipToPx(getContext(), 20));
        mImageContainer.addView(mProgressView, lpProgress);

        LayoutParams layoutParams = new LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
        layoutParams.rightMargin = dipToPx(getContext(), 20);
        // 将Container添加到Footer
