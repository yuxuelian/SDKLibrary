...
package com.kaibo.refresh.pathview;
...
class PathParser {
    ...
    static List<Path> transformScale(float ratioWidth, float ratioHeight, List<Path> orginPaths, List<String> orginSvgs) {
     ...
     */
    static PathDataNode[] createNodesFromPathData(String pathData) {
        if (pathData == null) {
            return null;
        }
        int start = 0;
     ...
     */
    static boolean canMorph(PathDataNode[] nodesFrom, PathDataNode[] nodesTo) {
     ...
     */
    static void updateNodes(PathDataNode[] target, PathDataNode[] source) {
        for (int i = 0; i < source.length; i++) {
    ...
    static class PathDataNode {
         ...
         */
        void interpolatePathDataNode(PathDataNode nodeFrom,
