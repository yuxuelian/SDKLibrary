...
public class CustomViewBehind extends ViewGroup {
    ...
    public int getMenuPage(int page) {
        ...
        if (mMode == SwipeMenuLayout.LEFT && page > 1) {
            return 0;
        } else if (mMode == SwipeMenuLayout.RIGHT && page < 1) {
            return 2;
        } else {
            return page;
        }
    ...
    public int getAbsLeftBound(View content) {
        if (mMode == SwipeMenuLayout.LEFT || mMode == SwipeMenuLayout.LEFT_RIGHT) {
            return content.getLeft() - getBehindWidth();
        } else if (mMode == SwipeMenuLayout.RIGHT) {
            return content.getLeft();
        }
    ...
    public int getAbsRightBound(View content) {
        if (mMode == SwipeMenuLayout.LEFT) {
            return content.getLeft();
        } else if (mMode == SwipeMenuLayout.RIGHT || mMode == SwipeMenuLayout.LEFT_RIGHT) {
            return content.getLeft() + getBehindWidth();
        }
        return 0;
    }
    ...
    public boolean menuTouchInQuickReturn(View content, int currPage, float x) {
        if (mMode == SwipeMenuLayout.LEFT || (mMode == SwipeMenuLayout.LEFT_RIGHT && currPage == 0)) {
            return x >= content.getLeft();
        } else if (mMode == SwipeMenuLayout.RIGHT || (mMode == SwipeMenuLayout.LEFT_RIGHT && currPage == 2)) {
    ...
    public boolean menuClosedSlideAllowed(float dx) {
        if (mMode == SwipeMenuLayout.LEFT) {
            ...
            return mMode == SwipeMenuLayout.LEFT_RIGHT;
        }
    }
